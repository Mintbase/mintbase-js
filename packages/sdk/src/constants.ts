...
export const DEFAULT_CONTRACT_ADDRESS =  mbjs?.keys?.contractAddress || null;
...
export const MB_MARKET_ADDRESS =
  NEAR_NETWORK === Network.MAINNET ? MB_MAINNET_MARKET_CONTRACT_ADDRESS : MB_TESTNET_MARKET_CONTRACT_ADDRESS;
