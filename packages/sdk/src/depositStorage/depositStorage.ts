...
import { DepositStorageArgs, EmptyObject, MARKET_METHOD_NAMES, NearContractCall } from '../types';
 ...
 */
export const depositStorage = (args: DepositStorageArgs): NearContractCall<EmptyObject> => {
