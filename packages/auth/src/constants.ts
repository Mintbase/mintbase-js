...
export const NEAR_WALLET_ENV = (process.env.NEAR_WALLET_ENV || 'testnet') as NetworkId;
...
export const NEAR_LOGIN_CONTRACT_ID = (process.env.NEAR_LOGIN_CONTRACT_ID || DEFAULT_MINTBASE_CONTRACT);
