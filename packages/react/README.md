...
**_ALSO RECOMMENDED TO DO:_** you can set network and contractAddress (the one from your dapp/mintbase store) straight on the WalletContextProvider too like this:
