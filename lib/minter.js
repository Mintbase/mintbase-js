...
class Minter {
    ...
    getMetadataId() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const id = yield storage_1.uploadMetadata(this.currentMint, this.apiKey);
    ...
    upload(field, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield storage_1.uploadToArweave(file, this.apiKey);
