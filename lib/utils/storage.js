 ...
 */
const _uploadCloud = (buffer, contentType) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const uploadToArweave = (file, apiKey) => __awaiter(void 0, void 0, void 0, function* () {
    if (browser_or_node_1.isNode)
        throw new Error('Node environment does not yet supports uploads.');
    const buffer = yield file.arrayBuffer();
    const contentType = file.type;
    // Uploads to google cloud
    const fileName = yield _uploadCloud(buffer, contentType);
 ...
 */
const uploadMetadata = (metadata, apiKey) => __awaiter(void 0, void 0, void 0, function* () {
